...
#ifndef H_TALKCOIN_SCRIPT
#define H_TALKCOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CfalcoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, falcoin always counted CHECKMULTISIGs
