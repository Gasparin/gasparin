...
#ifndef _TALKCOINRPC_H_
#define _TALKCOINRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // falcoin is not connected
...
/**
 * falcoin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern json_spirit::Value vote2(const json_spirit::Array& params, bool fHelp);
