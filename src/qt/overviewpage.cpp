...
class TxViewDelegate : public QAbstractItemDelegate
{
    Q_OBJECT
public:
    TxViewDelegate(): QAbstractItemDelegate(), unit(falcoinUnits::FAL)
    {
                      ...
                      const QModelIndex &index ) const
    {
        ...
        painter->setPen(foreground);
        QString amountText = falcoinUnits::formatWithUnit(unit, amount, true);
        if(!confirmed)
        {
    ...
    filter(0)
{
    ...
    // ToolTips
    ui->btnVote->setToolTip(falcoinUnits::formatWithUnit(falcoinUnits::FAL, GET_V_VOTE()));
    ui->chkAutoVote->setToolTip(falcoinUnits::formatWithUnit(falcoinUnits::FAL, GET_V_VOTE()));
    ui->btnChatSend->setToolTip(falcoinUnits::formatWithUnit(falcoinUnits::FAL, GET_V_CHAT()));
    ui->btnChatBold->setToolTip(falcoinUnits::formatWithUnit(falcoinUnits::FAL, GET_V_CHATB()));
...
void OverviewPage::setBalance(qint64 balance, qint64 unconfirmedBalance, qint64 immatureBalance)
{
    ...
    ui->labelUnconfirmed->setText(falcoinUnits::formatWithUnit(unit, unconfirmedBalance));
    ui->labelImmature->setText(falcoinUnits::formatWithUnit(unit, immatureBalance));
...
void OverviewPage::showVote()
{
    ...
    ui->lblInfo->setText("► " + tr("Current reward: ")
                               + falcoinUnits::formatWithUnit(falcoinUnits::FAL, nSubsidy)
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("FAL")
    updateDisplayUnit();
}
