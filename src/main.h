...
#ifndef TALKCOIN_MAIN_H
#define TALKCOIN_MAIN_H
...
static const unsigned int MAX_TX_TLKDATA = 500;
...
static const int64 DUST_SOFT_LIMIT = 100000; // 0.001 FAL
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 1000;   // 0.00001 FAL mininput
...
public:
    ...
    */
    ...
    /** Amount of falcoins spent by this transaction.
    ...
    /** Amount of falcoins coming in to this transaction
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 4320 / 250;
    }
...
void UpdateCoins(const CTransaction& tx, CValidationState &state, CCoinsViewCache &inputs, CTxUndo &txundo, int nHeight, const uint256 &txhash);
    ...
    {
        std::string str;
        str += strprintf("CTransaction(hash=%s, ver=%d, vin.size=%"PRIszu", vout.size=%"PRIszu", nLockTime=%u, nVote=%"PRI64d", nVote2=%"PRI64d", TLKtime=%u, TLKnick=%s, TLKmsg=%s, TLKdata=%s)\n",
 ...
 *               * 8358: compact amount representation for 60000000000 (600 FAL)
 ...
 *             * 86ef97d579: compact amount representation for 234925952 (2.35 FAL)
 *             * 00: special txout type pay-to-pubkey-hash
 *             * 61b01caab50f1b8e9c50a5057eb43c2d9563a4ee: address uint160
 *  - vout[16]: bbd123008c988f1a4a4de2161e0f50aac7f17e7f9555caa4
 *              * bbd123: compact amount representation for 110397 (0.001 FAL)
 *              * 00: special txout type pay-to-pubkey-hash
