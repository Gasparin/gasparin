...
const char* GetOpName(opcodetype opcode)
{
    ...
    // stack ops
    case OP_TOALTSFALK             : return "OP_TOALTSFALK";
    case OP_FROMALTSFALK           : return "OP_FROMALTSFALK";
...
bool IsCanonicalSignature(const valtype &vchSig) {
    // See https://falcointalk.org/index.php?topic=8392.msg127623#msg127623
...
bool Solver(const CScript& scriptPubKey, txnouttype& typeRet, vector<vector<unsigned char> >& vSolutionsRet)
{
    ...
    if (mTemplates.empty())
    {
        ...
        // falcoin address tx, sender provides hash of pubkey, receiver provides signature and pubkey
